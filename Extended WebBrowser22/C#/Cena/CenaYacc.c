...
/*  A Bison parser, made from cena.y
...
#line 16 "cena.y"
typedef union {int valInt;double valFloat;} YYSTYPE;
#ifndef YYDEBUG
#define YYDEBUG 1
#endif
...
static const short yyprhs[] = {     0,
     0,     2,     5,     7,    10,    15,    17,    20,    22,    25,
    27
};

static const short yyrhs[] = {    13,
     0,     1,    11,     0,    14,     0,    13,    14,     0,     6,
     9,    15,    16,     0,     1,     0,     8,     3,     0,     4,
     0,     4,    17,     0,    10,     0,    17,    10,     0
};
...
static const char * const yytname[] = {   "$","error","$undefined.","yearKey",
"cenaKey","otKey","DIGIT1","DIGIT","DIGIT2","DIGIT3","FLOATDIG","'\\n'","input",
"lines","line","year","cena","digitSumm", NULL
};
#endif
...
static const short yypact[] = {     1,
    -8,    -5,     0,-32768,-32768,    -3,-32768,-32768,     5,     6,
-32768,    -1,-32768,-32768,     2,-32768,    11,    13,-32768
};

static const short yypgoto[] = {-32768,
-32768,    12,-32768,-32768,-32768
};
...
static const short yytable[] = {    -1,
     7,     1,     5,     6,     9,     2,     2,    11,    14,    12,
    18,    16,    19,     0,     8
};

static const short yycheck[] = {     0,
     1,     1,    11,     9,     8,     6,     6,     3,    10,     4,
     0,    10,     0,    -1,     3
};
...
//			if($3==1997){summ97+=$4;summ=summ97;printf(str,$1,$3,$4);}
			if(yyvsp[-2].valInt==97){summ97+=yyvsp[0].valFloat;summ=summ97;}//printf(str,$1,$2,$4);}
//			else if($3==1998)
			else if(yyvsp[-2].valInt==98)
			{
/*
				if($2<$3&&$4>=10000000)
...
*/
				summ98+=yyvsp[0].valFloat;summ=summ98;
			}
//			else if($3==1999)
			else if(yyvsp[-2].valInt==99)
			{
/*
				if($2<$3&&$4>=10000000)
...
*/
				summ99+=yyvsp[0].valFloat;summ=summ99;//printf(str,$1,$2,cena99);
			}
			printf(str,yyvsp[-3].valInt,yyvsp[-2].valInt,yyvsp[-1].valInt,yyvsp[0].valFloat);
			CharToOem("\t\tСумма за %d г. = %.2f\n",str);
			printf(str,yyvsp[-2].valInt,summ);
		;
    break;}
case 7:
#line 80 "cena.y"
...
case 11:
#line 83 "cena.y"
{yyval.valFloat=yyvsp[-1].valFloat+yyvsp[0].valFloat;;
    break;}
}
