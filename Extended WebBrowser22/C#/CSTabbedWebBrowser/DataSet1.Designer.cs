...
namespace CSTabbedWebBrowser {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersonRow AddPersonRow(string fullName, string shortName, string passport, string address) {
        ...
        public partial class KruzhkaDataTable : global::System.Data.TypedTableBase<KruzhkaRow> {
            ...
            private global::System.Data.DataColumn columnUrEddress;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public global::System.Data.DataColumn UrEddressColumn {
                get {
                    return this.columnUrEddress;
                }
            }
            ...
            internal void InitVars() {
                ...
                this.columnUrEddress = base.Columns["UrEddress"];
            ...
            private void InitClass() {
                ...
                this.columnUrEddress = new global::System.Data.DataColumn("UrEddress", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnUrEddress);
                ...
                this.columnUrEddress.MaxLength = 255;
        ...
        public partial class KruzhkaRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public string UrEddress {
                get {
                    try {
                        return ((string)(this[this.tableKruzhka.UrEddressColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'UrEddress\' in table \'Kruzhka\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableKruzhka.UrEddressColumn] = value;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsUrEddressNull() {
                return this.IsNull(this.tableKruzhka.UrEddressColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetUrEddressNull() {
                this[this.tableKruzhka.UrEddressColumn] = global::System.Convert.DBNull;
            }
...
namespace CSTabbedWebBrowser.DataSet1TableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Person` WHERE ((`Код` = ?) AND ((? = 1 AND `fullName` IS NULL) OR (`fullName` = ?)) AND ((? = 1 AND `shortName` IS NULL) OR (`shortName` = ?)) AND ((? = 1 AND `passport` IS NULL) OR (`passport` = ?)) AND ((? = 1 AND `address` IS NULL) OR (`address` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Person` (`fullName`, `shortName`, `passport`, `address`) VALUES (?, " +
                "?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Person` SET `fullName` = ?, `shortName` = ?, `passport` = ?, `address` = ? WHERE ((`Код` = ?) AND ((? = 1 AND `fullName` IS NULL) OR (`fullName` = ?)) AND ((? = 1 AND `shortName` IS NULL) OR (`shortName` = ?)) AND ((? = 1 AND `passport` IS NULL) OR (`passport` = ?)) AND ((? = 1 AND `address` IS NULL) OR (`address` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код, fullName, shortName, passport, address FROM Person";
        ...
        public virtual int Delete(int Original_Код, string Original_fullName, string Original_shortName, string Original_passport, string Original_address) {
        ...
        public virtual int Insert(string fullName, string shortName, string passport, string address) {
            if ((fullName == null)) {
        ...
        public virtual int Update(string fullName, string shortName, string passport, string address, int Original_Код, string Original_fullName, string Original_shortName, string Original_passport, string Original_address) {
            if ((fullName == null)) {
    ...
    public partial class KruzhkaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("UrEddress", "UrEddress");
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("IsNull_UrEddress", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "UrEddress", global::System.Data.DataRowVersion.Original, true, null));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_UrEddress", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "UrEddress", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.InsertCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO `Kruzhka` (`KruzhkaID`, `FirstName`, `LastName`, `IdName`, `Passwd`, `HireDate`, `Address`, `Buhgalter`, `DirectorSN`, `Director`, `AddKruzhki`, `UrEddress`, `FactEddress`, `Telefon`, `Fax`, `Comment`, `ETokenPwd`, `ReadOnly`, `Vip`, `Age`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("UrEddress", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "UrEddress", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Kruzhka` SET `KruzhkaID` = ?, `FirstName` = ?, `LastName` = ?, `IdName` = ?, `Passwd` = ?, `HireDate` = ?, `Address` = ?, `Buhgalter` = ?, `DirectorSN` = ?, `Director` = ?, `AddKruzhki` = ?, `UrEddress` = ?, `FactEddress` = ?, `Telefon` = ?, `Fax` = ?, `Comment` = ?, `ETokenPwd` = ?, `ReadOnly` = ?, `Vip` = ?, `Age` = ? WHERE ((`Код` = ?) AND ((? = 1 AND `KruzhkaID` IS NULL) OR (`KruzhkaID` = ?)) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `IdName` IS NULL) OR (`IdName` = ?)) AND ((? = 1 AND `Passwd` IS NULL) OR (`Passwd` = ?)) AND ((? = 1 AND `HireDate` IS NULL) OR (`HireDate` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `Buhgalter` IS NULL) OR (`Buhgalter` = ?)) AND ((? = 1 AND `DirectorSN` IS NULL) OR (`DirectorSN` = ?)) AND ((? = 1 AND `Director` IS NULL) OR (`Director` = ?)) AND ((? = 1 AND `AddKruzhki` IS NULL) OR (`AddKruzhki` = ?)) AND ((? = 1 AND `UrEddress` IS NULL) OR (`UrEddress` = ?)) AND ((? = 1 AND `FactEddress` IS NULL) OR (`FactEddress` = ?)) AND ((? = 1 AND `Telefon` IS NULL) OR (`Telefon` = ?)) AND ((? = 1 AND `Fax` IS NULL) OR (`Fax` = ?)) AND ((? = 1 AND `Comment` IS NULL) OR (`Comment` = ?)) AND ((? = 1 AND `ETokenPwd` IS NULL) OR (`ETokenPwd` = ?)) AND ((? = 1 AND `ReadOnly` IS NULL) OR (`ReadOnly` = ?)) AND ((? = 1 AND `Vip` IS NULL) OR (`Vip` = ?)) AND ((? = 1 AND `Age` IS NULL) OR (`Age` = ?)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("UrEddress", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "UrEddress", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("IsNull_UrEddress", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "UrEddress", global::System.Data.DataRowVersion.Original, true, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_UrEddress", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "UrEddress", global::System.Data.DataRowVersion.Original, false, null));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код, KruzhkaID, FirstName, LastName, IdName, Passwd, HireDate, Address, Bu" +
                "hgalter, DirectorSN, Director, AddKruzhki, UrEddress, FactEddress, Telefon, Fax," +
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DataSet1.KruzhkaDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSet1.KruzhkaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.KruzhkaDataTable dataTable = new DataSet1.KruzhkaDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.KruzhkaDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        public virtual int Delete(
            ...
            if ((Original_UrEddress == null)) {
                this.Adapter.DeleteCommand.Parameters[23].Value = ((object)(1));
                this.Adapter.DeleteCommand.Parameters[24].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.DeleteCommand.Parameters[23].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[24].Value = ((string)(Original_UrEddress));
            }
        ...
        public virtual int Insert(
            ...
            if ((UrEddress == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[11].Value = ((string)(UrEddress));
            }
            if ((FactEddress == null)) {
        ...
        public virtual int Update(
            ...
            if ((UrEddress == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(UrEddress));
            }
            if ((FactEddress == null)) {
                this.Adapter.UpdateCommand.Parameters[12].Value = global::System.DBNull.Value;
            }
            ...
            if ((Original_UrEddress == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[44].Value = ((string)(Original_UrEddress));
            }
            if ((Original_FactEddress == null)) {
